...
#define IDIVB_CLK_SEL     CLK_SRC_IRC /* IDIVB input clock: ENET TX       */
 ...
 *----------------------------------------------------------------------------*/
#define IDIVA_IDIV        40            /* Divide input clock by 3            */
#define IDIVB_IDIV        40             /* Divide input clock by 2            */
